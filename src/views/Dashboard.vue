...
import CustomToolheadCard from '@/components/custom/toolhead/ToolheadCard.vue'
import SetupCard from '@/components/custom/setup/SetupCard.vue'
import ResultCard from '@/components/custom/result/ResultCard.vue'
